        ...
        <div className="relative max-w-6xl mx-auto hidden lg:block">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-3xl p-12 shadow-2xl">
              <p className="text-sm tracking-widest text-[#7A3B3B] font-semibold mb-6 uppercase">Get In Touch</p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-700">hatuma.charles@email.com</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-[#7A3B3B] rounded-full flex items-center justify-center">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7A3B3B] focus:border-transparent outline-none transition"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7A3B3B] focus:border-transparent outline-none transition">
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7A3B3B] focus:border-transparent outline-none transition resize-none"
        ...
        <div className="relative max-w-4xl mx-auto hidden md:block lg:hidden">
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              <p className="text-xs tracking-widest text-[#7A3B3B] font-semibold mb-4 uppercase">Get In Touch</p>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <input
                  type="text"
                  className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7A3B3B] focus:border-transparent outline-none transition"
